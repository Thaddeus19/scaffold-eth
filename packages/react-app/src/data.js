const questionsForArticle1 = Object.freeze([
  {
    questionText:
...
const questionsForArticle2 = Object.freeze([
  {
    questionText:
      "2222What is the main problem the creators of this hack are trying to solve?",
    answerOptions: [
      {
        answerText:
          "Content discovery; creator compensation; consumer compensation; removing advertising; subscriptions, and paywall; removing click bait; and promoting healthier discussions online at scale.",
